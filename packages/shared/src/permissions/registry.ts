...
export const PERMISSION_REGISTRY: PermissionDefinition[] = [
  ...
  p('finance', 'eliminations', 'read', 'endpoint', 'View consolidation elimination rules and runs'),
  p('finance', 'eliminations', 'manage', 'endpoint', 'Create, update, and delete elimination rules'),
  p('finance', 'eliminations', 'run', 'endpoint', 'Execute auto-elimination runs and post elimination journals'),
