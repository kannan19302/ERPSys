...
base is exactly four files: `AUTOPILOT.md` (the protocol), `HANDBOOK.md` (how we build),
`MODULE_REGISTRY.md` (what exists + Collab Board), `CHANGELOG.md` (what happened).

| Task | Read These Files |
|:---|:---|
| Any task (start here) | `AUTOPILOT.md` |
