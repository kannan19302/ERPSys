  ...
  return (
    <div style={{
      ...
      <div className="frappe-card" style={{
        ...
        <div className="frappe-card-header" style={{
          display: 'flex',
          alignItems: 'center',
          gap: 'var(--space-3)',
        ...
        <div className="frappe-card-body" style={{ padding: 'var(--space-6)', display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' }}>
          {/* Main message */}
          <p style={{
          ...
          <div style={{
            ...
            <button className="frappe-btn frappe-btn-primary" onClick={handleReload}>
              <RefreshCw size={16} />
              Try Again
            </button>
            <button className="frappe-btn frappe-btn-secondary" onClick={handleGoToDashboard}>
              <Home size={16} />
              Go to Dashboard
            </button>
            <button className="frappe-btn frappe-btn-secondary" onClick={() => router.back()}>
              <ArrowLeft size={16} />
              Go Back
            </button>
            {email && (
              <button className="frappe-btn frappe-btn-secondary" onClick={handleSignOut} style={{ color: 'var(--color-danger-text)' }}>
                <LogOut size={16} />
                Sign Out
              </button>
            )}
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmitReport} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-4)' }}>
                  <div className="frappe-form-group" style={{ marginBottom: 0 }}>
                    <label className="frappe-label">Your Name</label>
                    <input
                      type="text"
                  ...
                  <div className="frappe-form-group" style={{ marginBottom: 0 }}>
                    <label className="frappe-label">Your Email</label>
                    <input
                      type="email"
                      className="frappe-input"
                      value={email}
                ...
                <div className="frappe-form-group" style={{ marginBottom: 0 }}>
                  <label className="frappe-label">What were you doing? (Required)</label>
                  <textarea
                    className="frappe-input"
                    value={description}
