...
import { Mail, CheckCircle, RefreshCw, AlertCircle, Play } from 'lucide-react';
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-6)', maxWidth: '900px' }}>
      <div>
        ...
        <p style={{ color: 'var(--color-text-secondary)', fontSize: 'var(--text-sm)' }}>
          Configure tenant-wide outgoing mail transfer protocol settings for transactional communications.
        </p>
      </div>
          ...
          <div style={{ background: 'var(--color-bg-elevated)', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-lg)', padding: 'var(--space-5)' }}>
            ...
            {testStatus && (
              <div style={{
                ...
                background: testStatus.success ? 'rgba(var(--color-success-rgb), 0.1)' : 'rgba(var(--color-error-rgb), 0.1)',
