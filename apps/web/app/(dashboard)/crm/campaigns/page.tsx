...
import {
  Card, PageHeader, Button, Badge, Modal, Drawer, DataTable, type Column,
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
      <PageHeader
        ...
        description="Acquisition channels, pipeline attribution, and ROI of promotional campaigns."
        breadcrumbs={[{ label: 'Home', href: '/dashboard' }, { label: 'CRM', href: '/crm' }, { label: 'Campaigns' }]}
        actions={<Button onClick={() => setIsModalOpen(true)}><Plus size={16} /> New Campaign</Button>}
      />
