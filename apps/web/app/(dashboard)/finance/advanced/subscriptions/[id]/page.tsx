          ...
          {sub.lines.length > 0 && (
            <Card className="p-6">
              ...
              <table className="w-full text-left text-sm border-collapse">
                ...
                <tbody>
                  {sub.lines.map((l) => (
                    <tr key={l.id} className="border-b text-slate-600">
                      <td className="py-3 font-medium text-slate-800">{l.description}</td>
                      <td className="py-3 text-right">{fmt(l.unitAmount, sub.currency)}</td>
                      <td className="py-3 text-center">{l.quantity}</td>
                      <td className="py-3 text-right">{l.taxRate}%</td>
                      <td className="py-3 text-right font-semibold text-slate-800">{fmt(l.totalAmount, sub.currency)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
