  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold frappe-text-primary">New Subscription</h1>
          <p className="text-sm frappe-text-muted mt-1">Register a new client subscription contract</p>
        </div>
      </div>
