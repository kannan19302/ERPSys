...
import { ShieldAlert, RefreshCw, AlertTriangle, Clock } from 'lucide-react';
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h1 style={{ fontSize: 'var(--text-2xl)', fontWeight: 'var(--weight-bold)', display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
            ...
            SLA Escalations & Delegation Logs
          </h1>
          <p style={{ color: 'var(--color-text-secondary)', fontSize: 'var(--text-sm)' }}>
            Monitor active approval requests against configured SLA thresholds and trigger delegation sweeps.
          </p>
        </div>
        ...
        >
          <RefreshCw size={14} className={checkingSla ? 'spin-animation' : ''} />
