...
class ApiPaths {
  ...
  static String onboardingComplete(String key) =>
  ...
  static String opportunityConvert(String id) =>
      '/sales/opportunities/$id/convert';
  static String opportunityTeam(String id) => '/sales/opportunities/$id/team';
  static String opportunityTeamMember(String id, String userId) =>
      '/sales/opportunities/$id/team/$userId';
  static String opportunityTags(String id) => '/sales/opportunities/$id/tags';
  static String opportunityTag(String id, String tagId) =>
      '/sales/opportunities/$id/tags/$tagId';
  static String opportunityContactRoles(String id) =>
      '/sales/opportunities/$id/contact-roles';
  ...
  static String dealRoomBuyerAccess(String id) =>
      '/sales/deal-rooms/$id/buyer-access';
  static String dealRoomMilestones(String id) =>
      '/sales/deal-rooms/$id/milestones';
  static String dealRoomStakeholders(String id) =>
      '/sales/deal-rooms/$id/stakeholders';
  static String dealRoomDocuments(String id) =>
      '/sales/deal-rooms/$id/documents';
  ...
  static String customerPortalAccess(String id) =>
      '/crm/customers/$id/portal-access';
  static String customerPortalAccessRevoke(String id, String userId) =>
      '/crm/customers/$id/portal-access/$userId';
  static String customerActivities(String id) =>
  ...
  static String recurringTemplateTrigger(String id) =>
      '/finance/recurring-templates/$id/trigger';
  ...
  static const String bankReconciliationImport =
      '/finance/bank-reconciliation/import';
  static const String bankReconciliationTransactions =
      '/finance/bank-reconciliation/transactions';
  static const String bankReconciliationMatch =
      '/finance/bank-reconciliation/match';
  static const String bankReconciliationConfirm =
      '/finance/bank-reconciliation/confirm';
  static const String forecastScenarios = '/finance/forecast/scenarios';
  static String forecastScenario(String id) =>
      '/finance/forecast/scenarios/$id';
  ...
  static String intercompanyTransfer(String id) =>
      '/finance/intercompany-transfers/$id';
  static const String investmentPortfolios = '/finance/investment-portfolios';
  static String investmentPortfolio(String id) =>
      '/finance/investment-portfolios/$id';
  static String investmentPortfolioTransactions(String id) =>
      '/finance/investment-portfolios/$id/transactions';
  static const String treasuryTransactions = '/finance/treasury/transactions';
  static String treasuryTransaction(String id) =>
      '/finance/treasury/transactions/$id';
  ...
  static String journalEntryPost(String id) =>
  ...
  static String leaveRequestReject(String id) =>
  ...
  static String payrollRunJournalize(String id) =>
      '/hr/payroll/runs/$id/journalize';
  ...
  static String performanceReviewSubmit(String id) =>
  ...
  static String purchaseOrderSubmit(String id) =>
  ...
  static String purchaseReceipt(String id) =>
      '/procurement/purchase-receipts/$id';
  ...
  static String supplierQuotation(String id) =>
      '/procurement/supplier-quotations/$id';
  static String supplierQuotationApprove(String id) =>
      '/procurement/supplier-quotations/$id/approve';
  static String supplierQuotationReject(String id) =>
      '/procurement/supplier-quotations/$id/reject';
  static String supplierQuotationConvert(String id) =>
      '/procurement/supplier-quotations/$id/convert';
  static const String purchaseRequisitions = '/procurement/requisitions';
  static String purchaseRequisition(String id) =>
      '/procurement/requisitions/$id';
  static String purchaseRequisitionApprove(String id) =>
      '/procurement/requisitions/$id/approve';
  static const String blanketAgreements = '/procurement/blanket-agreements';
  static String blanketAgreement(String id) =>
      '/procurement/blanket-agreements/$id';
  ...
  static String vendorRmaReceive(String id) =>
      '/procurement/vendor-rma/$id/receive';
  static const String subcontracting = '/procurement/subcontracting';
  static String subcontractingDetail(String id) =>
      '/procurement/subcontracting/$id';
  static String subcontractingComplete(String id) =>
      '/procurement/subcontracting/$id/complete';
  static const String supplierScorecards = '/procurement/supplier-scorecards';
  static String supplierScorecard(String id) =>
      '/procurement/supplier-scorecards/$id';
  ...
  static String supplierContractRenew(String id) =>
      '/procurement/contracts/$id/renew';
  static const String supplierAssessments = '/procurement/supplier-assessments';
  static String supplierAssessment(String id) =>
      '/procurement/supplier-assessments/$id';
  ...
  static String shipmentDeliver(String id) =>
      '/supply-chain/shipments/$id/deliver';
  ...
  static const String demandForecastGenerate =
      '/supply-chain/demand-forecast/generate';
  static String demandForecastPromote(String id) =>
      '/supply-chain/demand-forecast/$id/promote';
  ...
  static String reorderSuggestionApprove(String id) =>
      '/supply-chain/reorder/suggestions/$id/approve';
  ...
  static String dockAppointment(String id) =>
      '/supply-chain/dock-appointments/$id';
  static String dockAppointmentCheckin(String id) =>
      '/supply-chain/dock-appointments/$id/checkin';
  static String dockAppointmentComplete(String id) =>
      '/supply-chain/dock-appointments/$id/complete';
  static const String warehouseTransfers = '/supply-chain/warehouse-transfer';
  static String warehouseTransfer(String id) =>
      '/supply-chain/warehouse-transfer/$id';
  static String warehouseTransferComplete(String id) =>
      '/supply-chain/warehouse-transfer/$id/complete';
  static String warehouseTransferApprove(String id) =>
      '/supply-chain/warehouse-transfer/$id/approve';
  ...
  static String workOrderStart(String id) =>
  ...
  static String workOrderConsume(String id) =>
      '/manufacturing/work-orders/$id/consume';
  static String workOrderProduce(String id) =>
      '/manufacturing/work-orders/$id/produce';
  ...
  static String mrpPlannedOrderRelease(String id) =>
      '/manufacturing/mrp/planned-orders/$id/release';
  ...
  static String qualityInspection(String id) =>
      '/manufacturing/quality-inspections/$id';
  static String qualityInspectionVerify(String id) =>
      '/manufacturing/quality-inspections/$id/verify';
  ...
  static String ncrDisposition(String id) =>
      '/manufacturing/ncr/$id/disposition';
  static const String productionDashboard =
  ...
  static String projectChangeRequests(String id) =>
  ...
  static String projectTimesheetApprove(String id) =>
      '/projects/timesheets/$id/approve';
  ...
  static String projectPortfolioMembers(String id) =>
      '/projects/portfolios/$id/members';
  ...
  static String documentLegalHold(String id) =>
      '/drive/documents/$id/legal-hold';
  static const String documentTemplates = '/documents/templates';
  static String documentTemplateGenerate(String id) =>
  ...
  static String channelMembers(String id) =>
      '/communication/channels/$id/members';
  static String channelMember(String id, String userId) =>
      '/communication/channels/$id/members/$userId';
  static String channelMessages(String id) =>
  ...
  static String messageReaction(String id, String emoji) =>
      '/communication/messages/$id/react/$emoji';
  static String messageBookmark(String id) =>
      '/communication/messages/$id/bookmark';
  static String messageReply(String id) => '/communication/messages/$id/reply';
  static String messageForward(String id) =>
      '/communication/messages/$id/forward';
  ...
  static String meetingRecordingStart(String id) =>
      '/communication/meetings/$id/recording/start';
  static String meetingRecordingStop(String id) =>
      '/communication/meetings/$id/recording/stop';
  static String meetingSummary(String id) =>
      '/communication/meetings/$id/summary';
  ...
  static String workflowDefinitionActivate(String id) =>
      '/workflow/definitions/$id/activate';
  static String workflowDefinitionDeactivate(String id) =>
      '/workflow/definitions/$id/deactivate';
  static const String workflowInstances = '/workflow/instances';
  static String workflowInstance(String id) => '/workflow/instances/$id';
  static String workflowInstanceStep(String id) =>
      '/workflow/instances/$id/step';
  static String workflowInstanceAdvance(String id) =>
      '/workflow/instances/$id/advance';
  static String workflowInstanceCancel(String id) =>
  ...
  static String workflowTaskDelegate(String id) =>
      '/workflow/tasks/$id/delegate';
  static String workflowTaskEscalate(String id) =>
      '/workflow/tasks/$id/escalate';
  ...
  static String reportTemplateGenerate(String id) =>
      '/reporting/templates/$id/generate';
  ...
  static String educationFeeInvoice(String id) =>
      '/ext/education/fee-structures/$id';
  ...
  static String examResult(String id) =>
      '/ext/education/deep/exams/$id/results';
  ...
  static String realEstateTenantDetail(String id) =>
      '/ext/real-estate/tenants/$id';
  // Backend segment is "maintenance", not "maintenance-orders".
  static const String maintenanceOrders = '/ext/real-estate/maintenance';
  static String maintenanceOrder(String id) =>
      '/ext/real-estate/maintenance/$id';
  ...
  static String serviceSchedule(String id) =>
      '/ext/field-service/schedules/$id';
  static const String serviceContracts = '/ext/field-service/contracts';
  static String serviceContract(String id) =>
      '/ext/field-service/contracts/$id';
  ...
  static String peopleOnboardingTask(String id) =>
      '/people/onboarding-tasks/$id';
  ...
  static String assetMaintenanceSchedule(String id) =>
      '/fixed-assets/maintenance/$id';
  ...
  static const String intercompanyAgreements =
      '/advanced-finance/intercompany-agreements';
  static const String costAllocations = '/advanced-finance/cost-allocations';
  static const String revenueRecognition =
      '/advanced-finance/revenue-recognition';
  static const String fixedAssetAccounting =
      '/advanced-finance/fixed-asset-accounting';
  static String fixedAssetAcct(String id) =>
      '/advanced-finance/fixed-asset-accounting/$id';
  ...
  static String marketplaceSubmission(String id) =>
      '/marketplace/submissions/$id';
  ...
  static String serviceContractMgmt(String id) =>
      '/service-management/contracts/$id';
  static const String serviceLevelAgreements = '/service-management/slas';
  static String serviceLevelAgreement(String id) =>
      '/service-management/slas/$id';
  ...
  static String subscriptionBillingCycle(String id) =>
      '/subscriptions/billing/$id';
