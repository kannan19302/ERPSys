    ...
    return Scaffold(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              final r = await ref
                  .read(marketplaceAppListControllerProvider.notifier)
                  .delete(appId);
      ...
      body: async.when(
        ...
        error: (e, _) => FailureView(
            failure:
                e is Failure ? e : const ServerFailure('Could not load app.'),
        ...
        _SectionCard(
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.apps, color: t.primary, size: 40),
                  ...
                  if (app.rating != null)
                    Row(children: [
                      const Icon(Icons.star,
                          color: Colors.amber, size: TypeScale.lg),
        ...
        _SectionCard(
          child: Column(
            ...
            children: [
              ...
              _FieldRow('Status', app.status),
              _FieldRow('Downloads', Formatters.compact(app.downloadCount)),
              const _FieldRow('Reviews', ''),
              _FieldRow('Currency', app.currency),
              if (app.price > 0)
                _FieldRow('Price',
                    Formatters.currency(app.price, currencyCode: app.currency)),
            ],
          ),
        ),
      ],
