...
abstract class MarketplaceRemoteDataSource {
  ...
  Future<MarketplaceAppModel> updateApp(
  ...
  Future<MarketplaceAppVersionModel> createVersion(
      Map<String, dynamic> payload);
  Future<MarketplaceAppVersionModel> releaseVersion(String id);

  Future<Paginated<MarketplaceSubmissionModel>> listSubmissions(
      ListQuery query);
  Future<MarketplaceSubmissionModel> getSubmission(String id);
  Future<MarketplaceSubmissionModel> createSubmission(
      Map<String, dynamic> payload);
  Future<MarketplaceSubmissionModel> reviewSubmission(
...
class MarketplaceRemoteDataSourceImpl implements MarketplaceRemoteDataSource {
  ...
  Future<Paginated<MarketplaceSubmissionModel>> listSubmissions(
      ...
      _client.getPaginated<MarketplaceSubmissionModel>(
        ApiPaths.marketplaceSubmissions,
        query,
  ...
  @override
  Future<MarketplaceSubmissionModel> reviewSubmission(
          String id, String decision, String? notes) async =>
      MarketplaceSubmissionModel.fromJson(
        await _client.post(
          '${ApiPaths.marketplaceSubmission(id)}/review',
