    ...
    if (item == null) {
      return Scaffold(
        ...
        body: const FailureView(
            failure: NotFoundFailure('Subscription not found')),
      );
    }
    return Scaffold(
      appBar: AppBar(title: const Text('Push Subscription')),
        ...
        _SectionCard(
          child: Column(
            ...
            children: [
              ...
              _FieldRow(
                  'P256DH Key',
                  subscription.p256dhKey.length > 40
                      ? '${subscription.p256dhKey.substring(0, 40)}...'
            ...
            children: [
              ...
              _FieldRow(
                  ...
                  subscription.createdAt != null
                      ? Formatters.dateTime(subscription.createdAt!)
                      : '—'),
              _FieldRow(
                  'Last Push',
                  subscription.lastPushedAt != null
                      ? Formatters.dateTime(subscription.lastPushedAt!)
                      : '—'),
              _FieldRow(
                  'Expires',
                  subscription.expiresAt != null
                      ? Formatters.dateTime(subscription.expiresAt!)
                      : '—'),
            ],
          ),
        ),
