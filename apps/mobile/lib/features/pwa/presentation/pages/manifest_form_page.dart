...
class _ManifestFormPageState extends ConsumerState<ManifestFormPage> {
  ...
  Future<void> _loadManifest() async {
    ...
    if (config != null) {
      _appNameCtrl.text = config.appName;
      _shortNameCtrl.text = config.shortName;
      _themeColorCtrl.text = config.themeColor;
      _bgColorCtrl.text = config.backgroundColor;
      _startUrlCtrl.text = config.startUrl;
  ...
  Future<void> _save() async {
    ...
    final payload = <String, dynamic>{
      ...
      'startUrl': _startUrlCtrl.text.trim(),
    };
    final result = await ref
        .read(pushSubscriptionListControllerProvider.notifier)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Manifest Config'), actions: [
        TextButton(
        ...
        child: ListView(
          ...
          children: [
                ...
                Expanded(
                    child: TextFormField(
                        ...
                        decoration: const InputDecoration(
                            labelText: 'Theme Color', hintText: '#000000'))),
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                DropdownMenuItem(
                    value: 'standalone', child: Text('Standalone')),
                DropdownMenuItem(
                    value: 'fullscreen', child: Text('Fullscreen')),
                DropdownMenuItem(
                    value: 'minimal-ui', child: Text('Minimal UI')),
