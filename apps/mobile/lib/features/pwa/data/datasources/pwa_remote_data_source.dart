...
abstract class PwaRemoteDataSource {
  Future<Paginated<PwaPushSubscriptionModel>> listPushSubscriptions(
      ListQuery query);
  Future<void> deletePushSubscription(String id);
  Future<PwaManifestConfigModel> getManifestConfig();
  Future<PwaManifestConfigModel> updateManifestConfig(
...
class PwaRemoteDataSourceImpl implements PwaRemoteDataSource {
  ...
  @override
  Future<Paginated<PwaOfflineQueueItemModel>> listOfflineQueue(
          ListQuery query) =>
      _client.getPaginated<PwaOfflineQueueItemModel>(
        ApiPaths.pwaOfflineQueue,
        query,
