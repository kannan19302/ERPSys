...
abstract class ProcurementRemoteDataSource {
  ...
  Future<Paginated<SupplierQuotationModel>> listSupplierQuotations(
      ListQuery query);
  ...
  Future<Paginated<SupplierContractModel>> listSupplierContracts(
      ListQuery query);
...
class ProcurementRemoteDataSourceImpl implements ProcurementRemoteDataSource {
  ...
  @override
  Future<PurchaseRequisitionModel> approvePurchaseRequisition(
          String id) async =>
      PurchaseRequisitionModel.fromJson(
  ...
  @override
  Future<Paginated<PurchaseReceiptModel>> listPurchaseReceipts(
          ListQuery query) =>
      _client.getPaginated<PurchaseReceiptModel>(
        ApiPaths.purchaseReceipts,
        query,
