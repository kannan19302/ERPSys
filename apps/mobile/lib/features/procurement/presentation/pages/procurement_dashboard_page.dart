                    ...
                    child: Row(
                      children: [
                        SizedBox(
                            ...
                            child: Text(dp.label,
                                style:
                                    const TextStyle(fontSize: TypeScale.xs))),
                        Expanded(
                        ...
                        Text(Formatters.compact(dp.value),
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  const Expanded(
                      child: UiSectionHeader(title: 'Recent Purchase Orders')),
                  TextButton(
              ...
              ...stats.recentPOs.take(5).map(
                    (po) => Padding(
                      padding: const EdgeInsets.symmetric(vertical: Spacing.x1),
                      child: InkWell(
                        onTap: () => context.pushNamed('po-detail',
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(Formatters.currency(po.totalAmount),
          ...
          UiCard(
            child: Row(
              children: [
                ...
                const SizedBox(width: Spacing.x2),
                Text(
                  '${stats.overdueDeliveries} overdue deliver${stats.overdueDeliveries == 1 ? 'y' : 'ies'}',
