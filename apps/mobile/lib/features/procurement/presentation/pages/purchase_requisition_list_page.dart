...
class PurchaseRequisitionListPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PurchaseRequisitionListPage> createState() =>
      _PurchaseRequisitionListPageState();
}

class _PurchaseRequisitionListPageState
    extends ConsumerState<PurchaseRequisitionListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final controller =
        ref.read(purchaseRequisitionListControllerProvider.notifier);
            ...
            child: Row(
              children: [
                Text(
                  state.isLoading
                      ? 'Loading...'
                      : '${state.meta.total} requisition${state.meta.total == 1 ? '' : 's'}',
                  style:
  ...
  Widget _body(PurchaseRequisitionListState state,
      PurchaseRequisitionListController controller) {
    ...
    return PaginatedListView<PurchaseRequisition>(
      ...
      itemBuilder: (_, r, __) => Card(
        ...
        child: InkWell(
          onTap: () => context.pushNamed('purchase-requisition-detail',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: Spacing.x1),
                Text('\$${r.totalEstimated.toStringAsFixed(2)}',
