...
class PurchaseReceiptListPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PurchaseReceiptListPage> createState() =>
      _PurchaseReceiptListPageState();
}

class _PurchaseReceiptListPageState
    extends ConsumerState<PurchaseReceiptListPage> {
            ...
            child: Row(
              children: [
                Text(
                  state.isLoading
                      ? 'Loading...'
                      : '${state.meta.total} receipt${state.meta.total == 1 ? '' : 's'}',
                  style: TextStyle(
  ...
  Widget _body(PurchaseReceiptListState state,
      PurchaseReceiptListController controller) {
    ...
    return PaginatedListView<PurchaseReceipt>(
      ...
      itemBuilder: (_, r, __) => Card(
        ...
        child: InkWell(
          onTap: () => context.pushNamed('purchase-receipt-detail',
