...
class PurchaseReceiptFormPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PurchaseReceiptFormPage> createState() =>
      _PurchaseReceiptFormPageState();
}

class _PurchaseReceiptFormPageState
    extends ConsumerState<PurchaseReceiptFormPage> {
  ...
  Future<void> _save() async {
    ...
    final payload = <String, dynamic>{
      ...
      'warehouseName': _warehouseCtrl.text.trim().isEmpty
          ? null
        ...
        child: ListView(
          ...
          children: [
            TextFormField(
              ...
              decoration:
                  const InputDecoration(labelText: 'Purchase Order Reference'),
            ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: TextFormField(
                        ...
                        keyboardType: TextInputType.number,
                        decoration: const InputDecoration(
                            labelText: 'Accepted', isDense: true),
                      ),
                    ),
                    IconButton(
