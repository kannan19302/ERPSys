...
class SupplierContractListPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SupplierContractListPage> createState() =>
      _SupplierContractListPageState();
}

class _SupplierContractListPageState
    extends ConsumerState<SupplierContractListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final controller =
        ref.read(supplierContractListControllerProvider.notifier);
    return Scaffold(
  ...
  Widget _body(SupplierContractListState state,
      SupplierContractListController controller) {
    ...
    return PaginatedListView<SupplierContract>(
      ...
      itemBuilder: (_, c, __) => Card(
        ...
        child: InkWell(
          onTap: () => context.pushNamed('supplier-contract-detail',
