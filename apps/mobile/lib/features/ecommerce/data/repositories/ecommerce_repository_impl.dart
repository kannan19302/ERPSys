...
class EcommerceRepositoryImpl implements EcommerceRepository {
  ...
  @override
  Future<Result<Cacheable<Paginated<EcommerceProduct>>>> listProducts(
          ListQuery q) =>
      _paginated(_productNamespace, q, () => _remote.listProducts(q),
          EcommerceProductModel.fromJson);

  @override
  Future<Result<EcommerceProduct>> getProduct(String id) =>
      _single(() => _remote.getProduct(id));
  ...
  @override
  Future<Result<EcommerceProduct>> updateProduct(
          String id, Map<String, dynamic> p) =>
      _write(() => _remote.updateProduct(id, p));

  @override
  Future<Result<void>> deleteProduct(String id) =>
      _delete(() => _remote.deleteProduct(id));

  @override
  Future<Result<Cacheable<Paginated<EcommerceCategory>>>> listCategories(
          ListQuery q) =>
      _paginated(_categoryNamespace, q, () => _remote.listCategories(q),
          EcommerceCategoryModel.fromJson);

  @override
  Future<Result<EcommerceCategory>> getCategory(String id) =>
      _single(() => _remote.getCategory(id));
  ...
  @override
  Future<Result<EcommerceCategory>> updateCategory(
          String id, Map<String, dynamic> p) =>
      _write(() => _remote.updateCategory(id, p));

  @override
  Future<Result<void>> deleteCategory(String id) =>
      _delete(() => _remote.deleteCategory(id));

  @override
  Future<Result<Cacheable<Paginated<EcommerceOrder>>>> listOrders(
          ListQuery q) =>
      _paginated(_orderNamespace, q, () => _remote.listOrders(q),
          EcommerceOrderModel.fromJson);

  @override
  Future<Result<EcommerceOrder>> getOrder(String id) =>
      _single(() => _remote.getOrder(id));
  ...
  @override
  Future<Result<EcommerceCartItem>> updateCartItem(
          String id, Map<String, dynamic> p) =>
      _write(() => _remote.updateCartItem(id, p));

  @override
  Future<Result<void>> removeFromCart(String id) =>
      _delete(() => _remote.removeFromCart(id));
