    ...
    return Scaffold(
      ...
      body: async.when(
        ...
        error: (e, _) => FailureView(
          failure:
              e is Failure ? e : const ServerFailure('Could not load tenant.'),
        ...
        _SectionCard(
          child: Column(
            ...
            children: [
              ...
              _FieldRow('Storage Used',
                  '${tenant.storageUsed.toStringAsFixed(1)} GB'),
            ],
          ),
        ),
        const SizedBox(height: Spacing.x4),
          ...
          child: Column(
            ...
            children: [
              ...
              if (tenant.updatedAt != null)
                _FieldRow('Updated', Formatters.dateTime(tenant.updatedAt!)),
            ],
          ),
        ),
      ],
