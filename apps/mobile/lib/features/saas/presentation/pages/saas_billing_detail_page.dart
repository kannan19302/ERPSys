    ...
    return Scaffold(
      ...
      body: async.when(
        ...
        error: (e, _) => FailureView(
          failure:
              e is Failure ? e : const ServerFailure('Could not load invoice.'),
          ...
          child: Column(
            ...
            children: [
              ...
              if (invoice.paidAt != null)
                _FieldRow('Paid At', Formatters.dateTime(invoice.paidAt!)),
              if (invoice.createdAt != null)
                _FieldRow('Created', Formatters.dateTime(invoice.createdAt!)),
              if (invoice.invoicePdf != null)
                _FieldRow('PDF', invoice.invoicePdf!),
            ],
          ),
        ),
      ],
