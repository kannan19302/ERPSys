...
abstract class SaasRemoteDataSource {
  ...
  Future<SaasSubscriptionModel> createSubscription(
      Map<String, dynamic> payload);
  Future<SaasSubscriptionModel> updateSubscription(
...
class SaasRemoteDataSourceImpl implements SaasRemoteDataSource {
  ...
  @override
  Future<SaasPlanModel> updatePlan(
  ...
  @override
  Future<void> deletePlan(String id) => _client.delete(ApiPaths.saasPlan(id));

  @override
  Future<Paginated<SaasSubscriptionModel>> listSubscriptions(ListQuery query) =>
      _client.getPaginated<SaasSubscriptionModel>(
        ApiPaths.saasSubscriptions,
        query,
  ...
  @override
  Future<SaasTenantModel> updateTenant(
          String id, Map<String, dynamic> payload) async =>
      SaasTenantModel.fromJson(
