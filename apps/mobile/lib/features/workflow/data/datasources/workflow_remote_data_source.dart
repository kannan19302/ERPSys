...
abstract class WorkflowRemoteDataSource {
  Future<Paginated<WorkflowDefinitionModel>> listWorkflowDefinitions(
      ListQuery query);
  Future<WorkflowDefinitionModel> getWorkflowDefinition(String id);
  Future<WorkflowDefinitionModel> createWorkflowDefinition(
  ...
  Future<Paginated<WorkflowInstanceModel>> listWorkflowInstances(
      ListQuery query);
...
class WorkflowRemoteDataSourceImpl implements WorkflowRemoteDataSource {
  ...
  @override
  Future<WorkflowDefinitionModel> deactivateWorkflowDefinition(
          String id) async =>
      WorkflowDefinitionModel.fromJson(
  ...
  @override
  Future<SlaRuleModel> updateSlaRule(
  ...
  @override
  Future<void> deleteSlaRule(String id) => _client.delete(ApiPaths.slaRule(id));
}
