...
class ProjectsRemoteDataSourceImpl implements ProjectsRemoteDataSource {
  ...
  @override
  Future<ProjectModel> getProject(String id) async => ProjectModel.fromJson(
  ...
  @override
  Future<void> deleteProject(String id) => _client.delete(ApiPaths.project(id));
  ...
  @override
  Future<TaskModel> getTask(String id) async => TaskModel.fromJson(
  ...
  @override
  Future<void> deleteTask(String id) => _client.delete(ApiPaths.taskDetail(id));
  ...
  Future<Paginated<MilestoneModel>> listProjectMilestones(
    ...
    ListQuery query,
      ...
      _client.getPaginated<MilestoneModel>(
        ApiPaths.projectMilestones(projectId),
        query,
        MilestoneModel.fromJson,
      );
  ...
  Future<Paginated<ProjectBudgetModel>> listProjectBudgets(
    String projectId,
      ...
      _client.getPaginated<ProjectBudgetModel>(
        ApiPaths.projectBudgets(projectId),
  ...
  Future<Paginated<ProjectRiskModel>> listProjectRisks(String projectId) =>
      _client.getPaginated<ProjectRiskModel>(
        ApiPaths.projectRisks(projectId),
        const ListQuery(limit: 100),
