...
abstract class BuilderRemoteDataSource {
  ...
  Future<BuilderWorkflowModel> updateWorkflow(
  ...
  Future<BuilderTemplateModel> updateTemplate(
      String id, Map<String, dynamic> payload);
...
class BuilderRemoteDataSourceImpl implements BuilderRemoteDataSource {
  ...
  @override
  Future<BuilderFormModel> updateForm(
  ...
  @override
  Future<BuilderPageModel> updatePage(
          String id, Map<String, dynamic> payload) async =>
      BuilderPageModel.fromJson(
  ...
  @override
  Future<BuilderWorkflowModel> createWorkflow(
  ...
  @override
  Future<BuilderTemplateModel> createTemplate(
          Map<String, dynamic> payload) async =>
      BuilderTemplateModel.fromJson(
