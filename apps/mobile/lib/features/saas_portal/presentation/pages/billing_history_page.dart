                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(info.companyName ?? 'Billing Info',
                                  style:
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (info.paymentMethod != null) ...[
                      ...
                      if (info.expMonth != null && info.expYear != null)
                        Text('Expires /',
                            style: TextStyle(
              ...
              _SectionCard(
                child: Column(
                  ...
                  children: [
                    ...
                    if (info.address != null) Text(info.address!),
                    if (info.city != null) Text(info.city!),
                    if (info.country != null) Text(info.country!),
                    if (info.zipCode != null) Text(info.zipCode!),
                  ],
                ),
              ),
            ],
