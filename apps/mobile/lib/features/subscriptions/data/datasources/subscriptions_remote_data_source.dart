...
abstract class SubscriptionsRemoteDataSource {
  ...
  Future<Paginated<SubscriptionBillingCycleModel>> listBillingCycles(
      ListQuery query);
  ...
  Future<ChurnSurveyResponseModel> submitChurnSurvey(
