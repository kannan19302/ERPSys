      ...
      body: async.when(
        ...
        error: (e, _) => FailureView(
          failure: e is Failure
              ? e
              : const ServerFailure('Could not load billing cycle.'),
          onRetry: () =>
              ref.invalidate(subscriptionBillingCycleDetailProvider(billingId)),
        ),
...
class _BillingDetail extends StatelessWidget {
  const _BillingDetail({required this.billing});
  final SubscriptionBillingCycle billing;
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(Formatters.currency(billing.amount),
                            style: TextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              if (billing.paidAt != null)
                _FieldRow('Paid At', Formatters.dateTime(billing.paidAt!)),
              if (billing.createdAt != null)
                _FieldRow('Created', Formatters.dateTime(billing.createdAt!)),
            ],
          ),
        ),
      ],
