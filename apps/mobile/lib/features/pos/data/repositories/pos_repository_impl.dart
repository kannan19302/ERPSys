...
class PosRepositoryImpl implements PosRepository {
  ...
  Future<Result<PosDiscount>> getPosDiscount(String id) =>
      _single(() => _remote.getPosDiscount(id));
  @override
  Future<Result<PosDiscount>> createPosDiscount(Map<String, dynamic> p) =>
      _write(() => _remote.createPosDiscount(p));
  @override
  Future<Result<PosDiscount>> updatePosDiscount(
          String id, Map<String, dynamic> p) =>
      _write(() => _remote.updatePosDiscount(id, p));
  @override
  Future<Result<void>> deletePosDiscount(String id) =>
      _delete(() => _remote.deletePosDiscount(id));

  @override
  Future<Result<Cacheable<Paginated<PosLoyaltyProgram>>>>
      listPosLoyaltyPrograms(ListQuery q) => _paginated(
          _loyaltyProgramNamespace,
          q,
          () => _remote.listPosLoyaltyPrograms(q),
          PosLoyaltyProgramModel.fromJson);
  @override
  Future<Result<PosLoyaltyProgram>> getPosLoyaltyProgram(String id) =>
      _single(() => _remote.getPosLoyaltyProgram(id));
  @override
  Future<Result<PosLoyaltyProgram>> createPosLoyaltyProgram(
          Map<String, dynamic> p) =>
      _write(() => _remote.createPosLoyaltyProgram(p));
  @override
  Future<Result<PosLoyaltyProgram>> updatePosLoyaltyProgram(
          String id, Map<String, dynamic> p) =>
      _write(() => _remote.updatePosLoyaltyProgram(id, p));
  @override
  Future<Result<void>> deletePosLoyaltyProgram(String id) =>
      _delete(() => _remote.deletePosLoyaltyProgram(id));

  @override
  Future<Result<Cacheable<Paginated<PosLoyaltyMember>>>> listPosLoyaltyMembers(
          ListQuery q) =>
      _paginated(
          _loyaltyMemberNamespace,
          q,
          () => _remote.listPosLoyaltyMembers(q),
          PosLoyaltyMemberModel.fromJson);
  @override
  Future<Result<PosLoyaltyMember>> getPosLoyaltyMember(String id) =>
      _single(() => _remote.getPosLoyaltyMember(id));
  @override
  Future<Result<PosLoyaltyMember>> createPosLoyaltyMember(
          Map<String, dynamic> p) =>
      _write(() => _remote.createPosLoyaltyMember(p));

  @override
  Future<Result<Cacheable<Paginated<PosLoyaltyTransaction>>>>
      listPosLoyaltyTransactions(ListQuery q) => _paginated(
          _loyaltyTxNamespace,
          q,
          () => _remote.listPosLoyaltyTransactions(q),
          PosLoyaltyTransactionModel.fromJson);
  @override
  Future<Result<PosLoyaltyTransaction>> createPosLoyaltyTransaction(
          Map<String, dynamic> p) =>
      _write(() => _remote.createPosLoyaltyTransaction(p));

  @override
  Future<Result<Cacheable<Paginated<PosCoupon>>>> listPosCoupons(ListQuery q) =>
      _paginated(_couponNamespace, q, () => _remote.listPosCoupons(q),
          PosCouponModel.fromJson);
  @override
  Future<Result<PosCoupon>> getPosCoupon(String id) =>
      _single(() => _remote.getPosCoupon(id));
  @override
  Future<Result<PosCoupon>> createPosCoupon(Map<String, dynamic> p) =>
      _write(() => _remote.createPosCoupon(p));
  @override
  Future<Result<PosCoupon>> updatePosCoupon(
          String id, Map<String, dynamic> p) =>
      _write(() => _remote.updatePosCoupon(id, p));
  @override
  Future<Result<void>> deletePosCoupon(String id) =>
      _delete(() => _remote.deletePosCoupon(id));
  ...
  Future<Result<PosGiftCard>> getPosGiftCard(String id) =>
      _single(() => _remote.getPosGiftCard(id));
  @override
  Future<Result<PosGiftCard>> createPosGiftCard(Map<String, dynamic> p) =>
      _write(() => _remote.createPosGiftCard(p));
  @override
  Future<Result<void>> deletePosGiftCard(String id) =>
      _delete(() => _remote.deletePosGiftCard(id));

  @override
  Future<Result<Cacheable<Paginated<PosPriceList>>>> listPosPriceLists(
          ListQuery q) =>
      _paginated(_priceListNamespace, q, () => _remote.listPosPriceLists(q),
          PosPriceListModel.fromJson);
  @override
  Future<Result<PosPriceList>> getPosPriceList(String id) =>
      _single(() => _remote.getPosPriceList(id));
  @override
  Future<Result<PosPriceList>> createPosPriceList(Map<String, dynamic> p) =>
      _write(() => _remote.createPosPriceList(p));
  @override
  Future<Result<PosPriceList>> updatePosPriceList(
          String id, Map<String, dynamic> p) =>
      _write(() => _remote.updatePosPriceList(id, p));
  @override
  Future<Result<void>> deletePosPriceList(String id) =>
      _delete(() => _remote.deletePosPriceList(id));
}
