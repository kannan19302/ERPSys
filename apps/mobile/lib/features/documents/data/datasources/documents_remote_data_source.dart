...
class DocumentsRemoteDataSourceImpl implements DocumentsRemoteDataSource {
  ...
  @override
  Future<void> deleteFolder(String id) => _client.delete(ApiPaths.folder(id));
  ...
  @override
  Future<DocumentModel> getDocument(String id) async => DocumentModel.fromJson(
  ...
  @override
  Future<DocumentModel> starDocument(String id) async => DocumentModel.fromJson(
  ...
  @override
  Future<DocumentModel> signDocument(String id) async => DocumentModel.fromJson(
  ...
  Future<Paginated<DocumentVersionModel>> listDocumentVersions(
    ...
    ListQuery query,
      ...
      _client.getPaginated<DocumentVersionModel>(
        ApiPaths.documentVersions(documentId),
        query,
