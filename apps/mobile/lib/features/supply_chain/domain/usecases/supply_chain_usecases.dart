...
class ListShipmentsUseCase
    extends UseCase<Cacheable<Paginated<Shipment>>, ListQuery> {
...
class ListCarriersUseCase
    extends UseCase<Cacheable<Paginated<Carrier>>, ListQuery> {
...
class ListDemandForecastsUseCase
    extends UseCase<Cacheable<Paginated<DemandForecast>>, ListQuery> {
...
class GenerateDemandForecastUseCase
    extends UseCase<DemandForecast, Map<String, dynamic>> {
...
class ListReorderSuggestionsUseCase
    extends UseCase<Cacheable<Paginated<ReorderSuggestion>>, ListQuery> {
  const ListReorderSuggestionsUseCase(this._repository);
  final SupplyChainRepository _repository;
  @override
  Future<Result<Cacheable<Paginated<ReorderSuggestion>>>> call(
          ListQuery params) =>
      _repository.listReorderSuggestions(params);
}

class CalculateReorderUseCase
    extends UseCase<ReorderSuggestion, Map<String, dynamic>> {
...
class GenerateReorderOrdersUseCase
    extends UseCase<ReorderSuggestion, Map<String, dynamic>> {
...
class ApproveReorderSuggestionUseCase
    extends UseCase<ReorderSuggestion, String> {
...
class ListSupplyChainRoutesUseCase
    extends UseCase<Cacheable<Paginated<SupplyChainRoute>>, ListQuery> {
  const ListSupplyChainRoutesUseCase(this._repository);
  final SupplyChainRepository _repository;
  @override
  Future<Result<Cacheable<Paginated<SupplyChainRoute>>>> call(
          ListQuery params) =>
...
class GetSupplyChainRouteUseCase extends UseCase<SupplyChainRoute, String> {
  ...
  final SupplyChainRepository _repository;
  @override
  Future<Result<SupplyChainRoute>> call(String id) =>
      _repository.getSupplyChainRoute(id);
}
...
class SaveSupplyChainRouteUseCase
    extends UseCase<SupplyChainRoute, SaveSupplyChainRouteParams> {
...
class DeleteSupplyChainRouteUseCase extends UseCase<void, String> {
  ...
  Future<Result<void>> call(String id) =>
      _repository.deleteSupplyChainRoute(id);
}

class ListDockAppointmentsUseCase
    extends UseCase<Cacheable<Paginated<DockAppointment>>, ListQuery> {
  const ListDockAppointmentsUseCase(this._repository);
  final SupplyChainRepository _repository;
  @override
  Future<Result<Cacheable<Paginated<DockAppointment>>>> call(
          ListQuery params) =>
...
class GetDockAppointmentUseCase extends UseCase<DockAppointment, String> {
  ...
  final SupplyChainRepository _repository;
  @override
  Future<Result<DockAppointment>> call(String id) =>
      _repository.getDockAppointment(id);
}
...
class SaveDockAppointmentUseCase
    extends UseCase<DockAppointment, SaveDockAppointmentParams> {
...
class CheckinDockAppointmentUseCase extends UseCase<DockAppointment, String> {
  ...
  @override
  Future<Result<DockAppointment>> call(String id) =>
      _repository.checkinDockAppointment(id);
}
...
class CompleteDockAppointmentUseCase extends UseCase<DockAppointment, String> {
  ...
  @override
  Future<Result<DockAppointment>> call(String id) =>
      _repository.completeDockAppointment(id);
}

class ListWarehouseTransfersUseCase
    extends UseCase<Cacheable<Paginated<WarehouseTransfer>>, ListQuery> {
  const ListWarehouseTransfersUseCase(this._repository);
  final SupplyChainRepository _repository;
  @override
  Future<Result<Cacheable<Paginated<WarehouseTransfer>>>> call(
          ListQuery params) =>
...
class GetWarehouseTransferUseCase extends UseCase<WarehouseTransfer, String> {
  ...
  final SupplyChainRepository _repository;
  @override
  Future<Result<WarehouseTransfer>> call(String id) =>
      _repository.getWarehouseTransfer(id);
}
...
class SaveWarehouseTransferUseCase
    extends UseCase<WarehouseTransfer, SaveWarehouseTransferParams> {
...
class DeleteWarehouseTransferUseCase extends UseCase<void, String> {
  ...
  @override
  Future<Result<void>> call(String id) =>
      _repository.deleteWarehouseTransfer(id);
}

class ApproveWarehouseTransferUseCase
    extends UseCase<WarehouseTransfer, String> {
  const ApproveWarehouseTransferUseCase(this._repository);
  final SupplyChainRepository _repository;
  @override
  Future<Result<WarehouseTransfer>> call(String id) =>
      _repository.approveWarehouseTransfer(id);
}

class CompleteWarehouseTransferUseCase
    extends UseCase<WarehouseTransfer, String> {
  const CompleteWarehouseTransferUseCase(this._repository);
  final SupplyChainRepository _repository;
  @override
  Future<Result<WarehouseTransfer>> call(String id) =>
      _repository.completeWarehouseTransfer(id);
}

class ListTrackingEventsUseCase
    extends UseCase<Cacheable<Paginated<TrackingEvent>>, ListQuery> {
...
class CreateTrackingEventUseCase
    extends UseCase<TrackingEvent, Map<String, dynamic>> {
