...
abstract class SupplyChainRepository {
  ...
  Future<Result<Shipment>> updateShipment(
  ...
  Future<Result<Carrier>> updateCarrier(
      String id, Map<String, dynamic> payload);
  ...
  Future<Result<Cacheable<Paginated<ReorderSuggestion>>>>
      listReorderSuggestions(ListQuery query);
  Future<Result<ReorderSuggestion>> calculateReorder(
      Map<String, dynamic> payload);
  ...
  Future<Result<Cacheable<Paginated<WarehouseTransfer>>>>
      listWarehouseTransfers(ListQuery query);
  ...
  Future<Result<Cacheable<Paginated<TrackingEvent>>>> listTrackingEvents(
      ListQuery query);
  Future<Result<TrackingEvent>> createTrackingEvent(
      Map<String, dynamic> payload);
}
