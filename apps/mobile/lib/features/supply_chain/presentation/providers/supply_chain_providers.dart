...
final Provider<SupplyChainRemoteDataSource>
    supplyChainRemoteDataSourceProvider = Provider<SupplyChainRemoteDataSource>(
...
class ShipmentListController extends Notifier<ShipmentListState> {
  ...
  Future<Result<void>> delete(String id) async {
    final result = await DeleteShipmentUseCase(
      ref.read(supplyChainRepositoryProvider),
    )(id);
...
final FutureProviderFamily<Shipment, String> shipmentDetailProvider =
  ...
  final result = await GetShipmentUseCase(
    ref.watch(supplyChainRepositoryProvider),
  )(id);
...
final NotifierProvider<ReorderSuggestionListController,
        ReorderSuggestionListState> reorderSuggestionListControllerProvider =
    NotifierProvider<ReorderSuggestionListController,
        ReorderSuggestionListState>(
  ReorderSuggestionListController.new,
);

class ReorderSuggestionListController
    extends Notifier<ReorderSuggestionListState> {
  Timer? _searchDebounce;
...
final FutureProviderFamily<SupplyChainRoute, String> routeDetailProvider =
    FutureProvider.family((ref, id) async => throw UnimplementedError());
final FutureProviderFamily<DockAppointment, String>
    dockAppointmentDetailProvider =
    FutureProvider.family((ref, id) async => throw UnimplementedError());
final FutureProviderFamily<WarehouseTransfer, String>
    warehouseTransferDetailProvider =
    FutureProvider.family((ref, id) async => throw UnimplementedError());

final NotifierProvider<RouteListController, RouteListState>
    routeListControllerProvider =
    NotifierProvider(() => throw UnimplementedError());
final NotifierProvider<DockAppointmentListController, DockAppointmentListState>
    dockAppointmentListControllerProvider =
    NotifierProvider(() => throw UnimplementedError());
final NotifierProvider<WarehouseTransferListController,
        WarehouseTransferListState> warehouseTransferListControllerProvider =
    NotifierProvider(() => throw UnimplementedError());
final NotifierProvider<TrackingEventListController, TrackingEventListState>
    trackingEventListControllerProvider =
    NotifierProvider(() => throw UnimplementedError());
...
final Provider<SupplyChainDashboardState> supplyChainDashboardProvider =
...
class DockAppointmentListController extends Notifier<DockAppointmentListState> {
  ...
  void search(String term) {}
  Future<Result<void>> save(Map<String, dynamic> data) async =>
...
class WarehouseTransferListController
    extends Notifier<WarehouseTransferListState> {
  @override
