      ...
      body: state.isLoading
          ...
          : state.failure != null
              ? FailureView(
                  ...
                  onRetry: () => ref.invalidate(supplyChainDashboardProvider))
              : ListView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (state.shipmentsByStatus.isEmpty)
                            const Padding(
                              padding:
                                  EdgeInsets.symmetric(vertical: Spacing.x4),
                              child: Center(child: Text('No shipment data')),
                            )
                          else
                            ...state.shipmentsByStatus.entries.map(
                              (entry) => Padding(
