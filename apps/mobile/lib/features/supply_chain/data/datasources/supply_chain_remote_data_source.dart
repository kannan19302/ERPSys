...
abstract class SupplyChainRemoteDataSource {
  ...
  Future<Paginated<SupplyChainRouteModel>> listSupplyChainRoutes(
      ListQuery query);
  Future<SupplyChainRouteModel> getSupplyChainRoute(String id);
  Future<SupplyChainRouteModel> createSupplyChainRoute(
      Map<String, dynamic> payload);
  Future<SupplyChainRouteModel> updateSupplyChainRoute(
  ...
  Future<DockAppointmentModel> createDockAppointment(
      Map<String, dynamic> payload);
  Future<DockAppointmentModel> updateDockAppointment(
      String id, Map<String, dynamic> payload);
  ...
  Future<Paginated<WarehouseTransferModel>> listWarehouseTransfers(
      ListQuery query);
  Future<WarehouseTransferModel> getWarehouseTransfer(String id);
  Future<WarehouseTransferModel> createWarehouseTransfer(
      Map<String, dynamic> payload);
  Future<WarehouseTransferModel> updateWarehouseTransfer(
      String id, Map<String, dynamic> payload);
...
class SupplyChainRemoteDataSourceImpl implements SupplyChainRemoteDataSource {
  ...
  @override
  Future<ShipmentModel> getShipment(String id) async => ShipmentModel.fromJson(
  ...
  Future<CarrierModel> createCarrier(Map<String, dynamic> payload) async =>
      CarrierModel.fromJson(
          await _client.post(ApiPaths.carriers, body: payload));
  ...
  @override
  Future<Paginated<DockAppointmentModel>> listDockAppointments(
          ListQuery query) =>
      _client.getPaginated<DockAppointmentModel>(
        ApiPaths.dockAppointments,
        query,
  ...
  @override
  Future<TrackingEventModel> createTrackingEvent(
          Map<String, dynamic> payload) async =>
      TrackingEventModel.fromJson(
