          ...
          _SectionCard(
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.tune, color: t.primary, size: 40),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Configure index and search behaviour',
          ...
          _SectionCard(
            child: Column(
              ...
              children: [
                ...
                const Divider(),
                _resourceTile(t, 'Customers', true),
                _resourceTile(t, 'Contacts', true),
                _resourceTile(t, 'Leads', true),
                _resourceTile(t, 'Products', true),
                _resourceTile(t, 'Invoices', false),
                _resourceTile(t, 'Orders', true),
              ],
            ),
          ),
          const SizedBox(height: Spacing.x4),
          _SectionCard(
            child: Column(
              ...
              children: [
                ...
                const Divider(),
                ListTile(
                    title: const Text('Fuzzy Level'),
                    subtitle: const Text('1 - Low (default)'),
              ...
              children: [
                ...
                SizedBox(
                    ...
                    child: OutlinedButton.icon(
                        ...
                        label: const Text('Clear Search Cache'),
                        onPressed: () {})),
              ],
            ),
          ),
