...
abstract class SearchRemoteDataSource {
  ...
  Future<SearchIndexConfigModel> updateIndexConfig(
  ...
  Future<SearchSynonymGroupModel> updateSynonym(
      String id, Map<String, dynamic> payload);
...
class SearchRemoteDataSourceImpl implements SearchRemoteDataSource {
  ...
  Future<Paginated<SearchSynonymGroupModel>> listSynonyms(ListQuery query) =>
      _client.getPaginated<SearchSynonymGroupModel>(
        ApiPaths.searchSynonyms,
        query,
        SearchSynonymGroupModel.fromJson,
      );

  @override
  Future<SearchSynonymGroupModel> createSynonym(
