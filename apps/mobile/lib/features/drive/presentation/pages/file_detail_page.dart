    ...
    return Scaffold(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              final r = await ref
                  .read(driveFileListControllerProvider.notifier)
                  .delete(fileId);
      ...
      body: async.when(
        ...
        error: (e, _) => FailureView(
            ...
            onRetry: () => ref.invalidate(driveFileDetailProvider(fileId))),
            ...
            children: [
              Row(
                children: [
                  ...
                  if (file.isStarred)
                    Icon(Icons.star, color: t.warning, size: 24),
                ],
              ),
        ...
        _SectionCard(
          child: Column(
            ...
            children: [
              ...
              if (file.isDeleted && file.deletedAt != null)
                _FieldRow('Deleted', Formatters.dateTime(file.deletedAt!)),
            ],
          ),
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                if (file.updatedAt != null)
                  _FieldRow('Modified', Formatters.dateTime(file.updatedAt!)),
              ],
            ),
          ),
        ],
    ...
    return Scaffold(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              if (confirmed != true || !context.mounted) return;
              final r = await ref
                  .read(driveFolderListControllerProvider.notifier)
                  .delete(folderId);
              if (!context.mounted) return;
              r.fold(
                  (f) => ScaffoldMessenger.of(context)
      ...
      body: async.when(
        ...
        error: (e, _) => FailureView(
            ...
            onRetry: () => ref.invalidate(driveFolderDetailProvider(folderId))),
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(
                      folder.icon != null ? Icons.folder_special : Icons.folder,
          ...
          child: Column(
            ...
            children: [
              ...
              if (folder.parentId != null)
                _FieldRow('Parent', folder.parentId!),
            ],
          ),
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                if (folder.updatedAt != null)
                  _FieldRow('Modified', Formatters.dateTime(folder.updatedAt!)),
              ],
            ),
          ),
        ],
