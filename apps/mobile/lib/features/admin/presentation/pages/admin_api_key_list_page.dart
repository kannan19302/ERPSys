...
class AdminApiKeyListPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdminApiKeyListPage> createState() =>
      _AdminApiKeyListPageState();
}
...
class _AdminApiKeyListPageState extends ConsumerState<AdminApiKeyListPage> {
  ...
  Widget build(BuildContext context) {
    final AdminApiKeyListState state =
        ref.watch(adminApiKeyListControllerProvider);
    final AdminApiKeyListController controller =
        ref.read(adminApiKeyListControllerProvider.notifier);
  ...
  Widget _body(AdminApiKeyListState state, AdminApiKeyListController controller,
      Palette t) {
