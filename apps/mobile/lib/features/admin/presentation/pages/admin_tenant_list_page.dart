...
class AdminTenantListPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdminTenantListPage> createState() =>
      _AdminTenantListPageState();
}
...
class _AdminTenantListPageState extends ConsumerState<AdminTenantListPage> {
  ...
  Widget build(BuildContext context) {
    final AdminTenantListState state =
        ref.watch(adminTenantListControllerProvider);
    final AdminTenantListController controller =
        ref.read(adminTenantListControllerProvider.notifier);
              ...
              children: <Widget>[
                DropdownButton<String?>(
                  ...
                  onChanged: (String? v) {
                    ...
                    controller.applyFilters(v != null
                        ? <String, String>{'plan': v}
                        : <String, String>{});
                  },
                ),
  ...
  Widget _body(AdminTenantListState state, AdminTenantListController controller,
      Palette t) {
