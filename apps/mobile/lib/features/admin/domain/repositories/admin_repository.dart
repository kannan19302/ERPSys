...
abstract class AdminRepository {
  ...
  Future<Result<Cacheable<Paginated<AdminSetting>>>> listSettings(
      ListQuery query);
  Future<Result<AdminSetting>> updateSetting(
      String key, Map<String, dynamic> payload);

  Future<Result<Cacheable<Paginated<AdminAuditLog>>>> listAuditLogs(
      ListQuery query);
  Future<Result<SystemHealth>> getSystemHealth();

  Future<Result<Cacheable<Paginated<AdminApiKey>>>> listApiKeys(
      ListQuery query);
  ...
  Future<Result<Cacheable<Paginated<AdminTenant>>>> listTenants(
      ListQuery query);
