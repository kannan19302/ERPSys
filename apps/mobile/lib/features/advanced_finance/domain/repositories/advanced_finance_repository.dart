...
abstract class AdvancedFinanceRepository {
  Future<Result<Cacheable<Paginated<MultiCurrencyRate>>>>
      listMultiCurrencyRates(ListQuery query);
  ...
  Future<Result<Cacheable<Paginated<ConsolidationReport>>>>
      listConsolidationReports(ListQuery query);
  ...
  Future<Result<Cacheable<Paginated<IntercompanyAgreement>>>>
      listIntercompanyAgreements(ListQuery query);
  ...
  Future<Result<BudgetVersion>> createBudgetVersion(
      Map<String, dynamic> payload);

  Future<Result<Cacheable<Paginated<FinancialCloseTask>>>>
      listFinancialCloseTasks(ListQuery query);
