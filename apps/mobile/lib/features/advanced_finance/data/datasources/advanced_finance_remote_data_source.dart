...
abstract class AdvancedFinanceRemoteDataSource {
  Future<Paginated<MultiCurrencyRateModel>> listMultiCurrencyRates(
      ListQuery query);
  Future<MultiCurrencyRateModel> getMultiCurrencyRate(String id);
  Future<MultiCurrencyRateModel> createMultiCurrencyRate(
  ...
  Future<Paginated<ConsolidationReportModel>> listConsolidationReports(
      ListQuery query);
  Future<ConsolidationReportModel> getConsolidationReport(String id);
  Future<ConsolidationReportModel> createConsolidationReport(
      Map<String, dynamic> payload);

  Future<Paginated<IntercompanyAgreementModel>> listIntercompanyAgreements(
      ListQuery query);
  Future<IntercompanyAgreementModel> getIntercompanyAgreement(String id);
  Future<IntercompanyAgreementModel> createIntercompanyAgreement(
      Map<String, dynamic> payload);
  ...
  Future<CostAllocationModel> createCostAllocation(
      Map<String, dynamic> payload);
  Future<CostAllocationModel> updateCostAllocation(
      String id, Map<String, dynamic> payload);

  Future<Paginated<RevenueRecognitionEntryModel>> listRevenueRecognitionEntries(
      ListQuery query);
  ...
  Future<Paginated<FinancialCloseTaskModel>> listFinancialCloseTasks(
      ListQuery query);
  Future<FinancialCloseTaskModel> getFinancialCloseTask(String id);
  Future<FinancialCloseTaskModel> createFinancialCloseTask(
      Map<String, dynamic> payload);
...
class AdvancedFinanceRemoteDataSourceImpl
    implements AdvancedFinanceRemoteDataSource {
  ...
  Future<MultiCurrencyRateModel> getMultiCurrencyRate(String id) async =>
      MultiCurrencyRateModel.fromJson(
          await _client.getObject(ApiPaths.multiCurrencyRates));
  ...
  Future<Paginated<IntercompanyAgreementModel>> listIntercompanyAgreements(
      ...
      _client.getPaginated<IntercompanyAgreementModel>(
        ApiPaths.intercompanyAgreements,
        query,
        IntercompanyAgreementModel.fromJson,
      );

  @override
  Future<IntercompanyAgreementModel> getIntercompanyAgreement(
          String id) async =>
      IntercompanyAgreementModel.fromJson(
  ...
  Future<CostAllocationModel> getCostAllocation(String id) async =>
      CostAllocationModel.fromJson(
          await _client.getObject(ApiPaths.costAllocations));
  ...
  Future<Paginated<RevenueRecognitionEntryModel>> listRevenueRecognitionEntries(
      ...
      _client.getPaginated<RevenueRecognitionEntryModel>(
        ApiPaths.revenueRecognition,
        query,
        RevenueRecognitionEntryModel.fromJson,
      );

  @override
  Future<RevenueRecognitionEntryModel> getRevenueRecognitionEntry(
          String id) async =>
      RevenueRecognitionEntryModel.fromJson(
  ...
  Future<BudgetVersionModel> getBudgetVersion(String id) async =>
      BudgetVersionModel.fromJson(
          await _client.getObject(ApiPaths.budgetVersions));

  @override
  Future<BudgetVersionModel> createBudgetVersion(
          Map<String, dynamic> payload) async =>
      BudgetVersionModel.fromJson(
  ...
  Future<AuditTrailEntryModel> getAuditTrail(String id) async =>
      AuditTrailEntryModel.fromJson(
          await _client.getObject(ApiPaths.auditTrails));
}
