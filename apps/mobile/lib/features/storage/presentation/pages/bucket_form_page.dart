...
class _BucketFormPageState extends ConsumerState<BucketFormPage> {
  ...
  Future<void> _load() async {
    final b =
        ref.read(storageBucketDetailProvider(widget.bucketId!)).valueOrNull;
    if (b != null) {
      _nameCtrl.text = b.bucketName;
      _regionCtrl.text = b.region;
      _quotaCtrl.text = b.maxQuotaGb.toString();
      _provider = b.provider;
      _isPublic = b.isPublic;
      _versioning = b.versioning;
    }
  }
  ...
  Future<void> _save() async {
    ...
    final payload = <String, dynamic>{
      'bucketName': _nameCtrl.text.trim(),
      'provider': _provider,
      'region': _regionCtrl.text.trim(),
      'maxQuotaGb': int.tryParse(_quotaCtrl.text) ?? 100,
      'isPublic': _isPublic,
      'versioning': _versioning,
    };
    final result = await ref
        .read(bucketListControllerProvider.notifier)
        .save(payload, id: widget.bucketId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_isEditing ? 'Edit Bucket' : 'New Bucket'),
        actions: [
          TextButton(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(value: 'GCS', child: Text('Google Cloud')),
            ...
            TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Max Quota (GB)')),
            const SizedBox(height: Spacing.x4),
            SwitchListTile(
            ...
            SwitchListTile(
                ...
                value: _versioning,
                onChanged: (v) => setState(() => _versioning = v),
                contentPadding: EdgeInsets.zero),
          ],
        ),
      ),
