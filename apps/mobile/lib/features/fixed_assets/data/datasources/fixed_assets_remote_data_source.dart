...
abstract class FixedAssetsRemoteDataSource {
  ...
  Future<FixedAssetModel> updateFixedAsset(
      String id, Map<String, dynamic> payload);
  Future<void> deleteFixedAsset(String id);
  Future<FixedAssetModel> disposeFixedAsset(
      String id, Map<String, dynamic> payload);

  Future<Paginated<AssetDepreciationScheduleModel>> listDepreciationSchedules(
      ListQuery query);
  Future<AssetDepreciationScheduleModel> recordDepreciation(
      Map<String, dynamic> payload);

  Future<Paginated<AssetMaintenanceScheduleModel>> listMaintenanceSchedules(
      ListQuery query);
...
class FixedAssetsRemoteDataSourceImpl implements FixedAssetsRemoteDataSource {
  ...
  Future<FixedAssetModel> getFixedAsset(String id) async =>
      FixedAssetModel.fromJson(
          await _client.getObject(ApiPaths.fixedAsset(id)));

  @override
  Future<FixedAssetModel> createFixedAsset(
          Map<String, dynamic> payload) async =>
      FixedAssetModel.fromJson(
          await _client.post(ApiPaths.fixedAssets, body: payload));

  @override
  Future<FixedAssetModel> updateFixedAsset(
          String id, Map<String, dynamic> payload) async =>
      FixedAssetModel.fromJson(
          await _client.patch(ApiPaths.fixedAsset(id), body: payload));
  ...
  Future<Paginated<AssetMaintenanceScheduleModel>> listMaintenanceSchedules(
      ...
      _client.getPaginated<AssetMaintenanceScheduleModel>(
        ApiPaths.assetMaintenance,
        query,
        AssetMaintenanceScheduleModel.fromJson,
      );

  @override
  Future<AssetMaintenanceScheduleModel> getMaintenanceSchedule(
          String id) async =>
      AssetMaintenanceScheduleModel.fromJson(
  ...
  Future<AssetMaintenanceScheduleModel> updateMaintenanceSchedule(
    ...
    Map<String, dynamic> payload,
      ...
      AssetMaintenanceScheduleModel.fromJson(
        await _client.patch(ApiPaths.assetMaintenanceSchedule(id),
            body: payload),
      );
  ...
  @override
  Future<AssetMaintenanceScheduleModel> completeMaintenanceSchedule(
          String id) async =>
      AssetMaintenanceScheduleModel.fromJson(
  ...
  Future<AssetDisposalModel> getDisposal(String id) async =>
      AssetDisposalModel.fromJson(
          await _client.getObject(ApiPaths.assetDisposal(id)));

  @override
  Future<AssetDisposalModel> createDisposal(
          Map<String, dynamic> payload) async =>
      AssetDisposalModel.fromJson(
          await _client.post(ApiPaths.assetDisposals, body: payload));
