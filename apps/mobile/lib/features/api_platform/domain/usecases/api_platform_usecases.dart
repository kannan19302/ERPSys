...
class ListApiKeysUseCase
    extends UseCase<Cacheable<Paginated<ApiKey>>, ListQuery> {
...
class ListWebhooksUseCase
    extends UseCase<Cacheable<Paginated<WebhookEndpoint>>, ListQuery> {
  const ListWebhooksUseCase(this._repository);
  final ApiPlatformRepository _repository;
  @override
  Future<Result<Cacheable<Paginated<WebhookEndpoint>>>> call(
          ListQuery params) =>
...
class ListUsageLogsUseCase
    extends UseCase<Cacheable<Paginated<ApiUsageLog>>, ListQuery> {
...
class ListRateLimitsUseCase
    extends UseCase<Cacheable<Paginated<ApiRateLimitRule>>, ListQuery> {
  const ListRateLimitsUseCase(this._repository);
  final ApiPlatformRepository _repository;
  @override
  Future<Result<Cacheable<Paginated<ApiRateLimitRule>>>> call(
          ListQuery params) =>
...
class SaveRateLimitUseCase
    extends UseCase<ApiRateLimitRule, SaveRateLimitParams> {
...
class GetWebhookUseCase extends UseCase<WebhookEndpoint, String> {
  ...
  @override
  Future<Result<WebhookEndpoint>> call(String params) async =>
...
class GetUsageLogUseCase extends UseCase<ApiUsageLog, String> {
  ...
  final ApiPlatformRepository repository;
  @override
  Future<Result<ApiUsageLog>> call(String params) async =>
      throw UnimplementedError();
}
...
class GetApiKeyUseCase extends UseCase<ApiKey, String> {
  ...
  final ApiPlatformRepository repository;
  @override
  Future<Result<ApiKey>> call(String params) async =>
      throw UnimplementedError();
}
