...
abstract class RealEstateRemoteDataSource {
  ...
  Future<TenantDetailModel> updateTenant(
      String id, Map<String, dynamic> payload);
  Future<void> deleteTenant(String id);

  Future<Paginated<MaintenanceOrderModel>> listMaintenanceOrders(
      ListQuery query);
  Future<MaintenanceOrderModel> getMaintenanceOrder(String id);
  Future<MaintenanceOrderModel> createMaintenanceOrder(
  ...
  Future<Paginated<PropertyValuationModel>> listPropertyValuations(
      ListQuery query);
  Future<PropertyValuationModel> createPropertyValuation(
      Map<String, dynamic> payload);
}
...
class RealEstateRemoteDataSourceImpl implements RealEstateRemoteDataSource {
  ...
  Future<PropertyModel> createProperty(Map<String, dynamic> payload) async =>
      PropertyModel.fromJson(
          await _client.post(ApiPaths.properties, body: payload));

  @override
  Future<PropertyModel> updateProperty(
          String id, Map<String, dynamic> payload) async =>
      PropertyModel.fromJson(
          await _client.patch(ApiPaths.property(id), body: payload));
  ...
  @override
  Future<Paginated<LeaseModel>> listLeases(ListQuery query) => _client
      .getPaginated<LeaseModel>(ApiPaths.leases, query, LeaseModel.fromJson);
  ...
  Future<LeaseModel> updateLease(
          String id, Map<String, dynamic> payload) async =>
      LeaseModel.fromJson(
          await _client.patch(ApiPaths.lease(id), body: payload));

  @override
  Future<void> deleteLease(String id) => _client.delete(ApiPaths.lease(id));

  @override
  Future<Paginated<TenantDetailModel>> listTenants(ListQuery query) =>
      _client.getPaginated<TenantDetailModel>(
          ApiPaths.realEstateTenants, query, TenantDetailModel.fromJson);

  @override
  Future<TenantDetailModel> getTenant(String id) async =>
      TenantDetailModel.fromJson(
          await _client.getObject(ApiPaths.realEstateTenantDetail(id)));

  @override
  Future<TenantDetailModel> createTenant(Map<String, dynamic> payload) async =>
      TenantDetailModel.fromJson(
          await _client.post(ApiPaths.realEstateTenants, body: payload));

  @override
  Future<TenantDetailModel> updateTenant(
          String id, Map<String, dynamic> payload) async =>
      TenantDetailModel.fromJson(await _client
          .patch(ApiPaths.realEstateTenantDetail(id), body: payload));
  ...
  Future<MaintenanceOrderModel> getMaintenanceOrder(String id) async =>
      MaintenanceOrderModel.fromJson(
          await _client.getObject(ApiPaths.maintenanceOrder(id)));
