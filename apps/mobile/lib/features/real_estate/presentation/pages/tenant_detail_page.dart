    ...
    return ListView(
      ...
      children: [
          ...
          child: Column(
            ...
            children: [
              ...
              if (tenant.emergencyContact != null)
                _FieldRow('Emergency Contact', tenant.emergencyContact!),
              if (tenant.emergencyPhone != null)
                _FieldRow('Emergency Phone', tenant.emergencyPhone!),
            ],
          ),
        ),
        const SizedBox(height: Spacing.x4),
        _SectionCard(
          child: Column(
            ...
            children: [
              ...
              _FieldRow('Outstanding',
                  Formatters.currency(tenant.outstandingBalance)),
            ],
          ),
        ),
        if (tenant.createdAt != null) ...[
          ...
          _SectionCard(
              child:
                  _FieldRow('Created', Formatters.dateTime(tenant.createdAt!))),
        ],
      ],
    );
  }
