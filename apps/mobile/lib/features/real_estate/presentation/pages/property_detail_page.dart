  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          PermissionGate(
            permission: Permissions.realEstateDelete,
            child: IconButton(
      ...
      body: async.when(
        ...
        error: (e, _) => FailureView(
            failure: e is Failure
                ? e
                : const ServerFailure('Could not load property.'),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('${property.totalUnits} units',
                  ...
                  Container(
                    ...
                    decoration:
                        BoxDecoration(color: bg, borderRadius: Radii.pill),
                    child: Text(label,
                        style: TextStyle(
                            color: color,
        ...
        _SectionCard(
          child: Column(
            ...
            children: [
              ...
              _FieldRow('Address', property.address ?? '—'),
              _FieldRow('City', property.city ?? '—'),
              _FieldRow('State', property.state ?? '—'),
              _FieldRow('Zip', property.zipCode ?? '—'),
              _FieldRow('Country', property.country),
            ],
          ),
        ),
        const SizedBox(height: Spacing.x4),
        _SectionCard(
          child: Column(
            ...
            children: [
              ...
              _FieldRow('Total Units', '${property.totalUnits}'),
              _FieldRow('Occupied Units', '${property.occupiedUnits}'),
              _FieldRow('Occupancy Rate',
                  '${property.occupancyRate.toStringAsFixed(1)}%'),
              _FieldRow(
                  'Total Area', '${property.totalArea} ${property.areaUnit}'),
            ],
          ),
        ),
        const SizedBox(height: Spacing.x4),
          ...
          child: Column(
            ...
            children: [
              ...
              if (property.purchasePrice != null)
                _FieldRow('Purchase Price',
                    Formatters.currency(property.purchasePrice!)),
              if (property.currentValue != null)
                _FieldRow('Current Value',
