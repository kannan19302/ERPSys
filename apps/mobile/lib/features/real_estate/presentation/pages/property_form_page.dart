...
class _PropertyFormPageState extends ConsumerState<PropertyFormPage> {
  ...
  Future<void> _load() async {
    ...
    if (p != null) {
      ...
      _totalUnitsCtrl.text = '${p.totalUnits}';
      _totalAreaCtrl.text = '${p.totalArea}';
  ...
  Future<void> _save() async {
    ...
    final payload = <String, dynamic>{
      ...
      'status': _status,
      'totalUnits': int.tryParse(_totalUnitsCtrl.text) ?? 0,
      'totalArea': double.tryParse(_totalAreaCtrl.text) ?? 0,
      'purchasePrice': double.tryParse(_purchasePriceCtrl.text),
      'description': _descriptionCtrl.text.trim().isEmpty
          ? null
          : _descriptionCtrl.text.trim(),
      'amenities': _amenitiesCtrl.text.trim().isEmpty
          ? <String>[]
          : _amenitiesCtrl.text
              .split(',')
              .map((s) => s.trim())
    ...
    final result = await ref
        ...
        .save(payload, id: widget.propertyId);
        ...
        child: ListView(
          ...
          children: [
            ...
            TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'Amenities', helperText: 'Comma-separated')),
          ],
        ),
      ),
    );
