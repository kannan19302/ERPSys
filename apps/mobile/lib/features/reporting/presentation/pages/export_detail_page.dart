    ...
    return Scaffold(
      ...
      body: async.when(
        ...
        error: (e, _) => FailureView(
          failure:
              e is Failure ? e : const ServerFailure('Could not load export.'),
          ...
          child: Column(
            ...
            children: [
              ...
              if (export.fileUrl != null)
                _FieldRow('File URL', export.fileUrl!),
              if (export.fileSize != null)
                _FieldRow('Size',
                    '${(export.fileSize! / 1024).toStringAsFixed(1)} KB'),
              if (export.createdAt != null)
                _FieldRow('Created', Formatters.dateTime(export.createdAt!)),
            ],
          ),
        ),
      ],
