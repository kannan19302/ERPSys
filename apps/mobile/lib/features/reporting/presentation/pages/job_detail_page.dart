    ...
    return Scaffold(
      ...
      body: async.when(
        ...
        error: (e, _) => FailureView(
          failure:
              e is Failure ? e : const ServerFailure('Could not load job.'),
            ...
            children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(job.templateName ?? 'Report Job',
              ...
              if (job.error != null)
                Padding(
                    ...
                    child: Text(job.error!, style: TextStyle(color: t.danger))),
            ],
          ),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              if (job.startedAt != null)
                _FieldRow('Started', Formatters.dateTime(job.startedAt!)),
              if (job.completedAt != null)
                _FieldRow('Completed', Formatters.dateTime(job.completedAt!)),
              if (job.duration != null)
                _FieldRow(
                    'Duration', Formatters.compact(job.duration!.inSeconds)),
              if (job.createdAt != null)
                _FieldRow('Created', Formatters.dateTime(job.createdAt!)),
            ],
          ),
        ),
      ],
