...
class ReportingRemoteDataSourceImpl implements ReportingRemoteDataSource {
  ...
  @override
  Future<ReportTemplateModel> createTemplate(
  ...
  @override
  Future<ReportJobModel> getJob(String id) async => ReportJobModel.fromJson(
