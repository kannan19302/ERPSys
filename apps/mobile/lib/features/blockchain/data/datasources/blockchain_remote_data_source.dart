...
abstract class BlockchainRemoteDataSource {
  Future<Paginated<BlockchainTransactionModel>> listTransactions(
      ListQuery query);
  ...
  Future<Paginated<BlockchainAuditEntryModel>> listAuditEntries(
      ListQuery query);
  Future<BlockchainAuditEntryModel> getAuditEntry(String id);

  Future<Paginated<BlockchainNetworkHealthModel>> listNetworkHealth(
      ListQuery query);
...
class BlockchainRemoteDataSourceImpl implements BlockchainRemoteDataSource {
  ...
  Future<Paginated<BlockchainNetworkHealthModel>> listNetworkHealth(
      ...
      _client.getPaginated<BlockchainNetworkHealthModel>(
        ApiPaths.blockchainNetworkHealth,
        query,
