...
abstract class ServiceManagementRemoteDataSource {
  ...
  Future<ServiceCatalogModel> updateCatalog(
  ...
  Future<ServiceContractModel> updateContract(
      String id, Map<String, dynamic> payload);
  ...
  Future<ServiceLevelAgreementModel> updateSla(
      String id, Map<String, dynamic> payload);
...
class ServiceManagementRemoteDataSourceImpl
  ...
  @override
  Future<ServiceCatalogModel> createCatalog(
  ...
  Future<ServiceRequestModel> assignRequest(String id, String userId) async =>
      ServiceRequestModel.fromJson(
        await _client.post('${ApiPaths.serviceRequest(id)}/assign',
            body: <String, dynamic>{'userId': userId}),
      );

  @override
  Future<ServiceRequestModel> resolveRequest(
          String id, String resolution) async =>
      ServiceRequestModel.fromJson(
        await _client.post('${ApiPaths.serviceRequest(id)}/resolve',
  ...
  @override
  Future<ServiceContractModel> createContract(
          Map<String, dynamic> payload) async =>
      ServiceContractModel.fromJson(
  ...
  Future<Paginated<ServiceLevelAgreementModel>> listSlas(ListQuery query) =>
      _client.getPaginated<ServiceLevelAgreementModel>(
        ApiPaths.serviceLevelAgreements,
        query,
  ...
  @override
  Future<ServiceLevelAgreementModel> createSla(
          Map<String, dynamic> payload) async =>
      ServiceLevelAgreementModel.fromJson(
