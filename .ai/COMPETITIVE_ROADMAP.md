...
## 8. Issues created (2026-07-22 seeding pass)

- **Epics**: kannan19302/ERPSys#42-#81 — one per of the 39 registry modules.
  kannan19302/ERPSys#82-#85 — the 4 externalized industry apps (PI-14+, Phase X candidates).
- **Sprint 1-3 stories (Finance, PI-1, worked example)**: kannan19302/ERPSys#86-#92.

All future cycles' Story issues are opened/closed by the `sprint-sync` skill
(§ 6) rather than seeded manually — this section is a one-time bootstrap
record, not something to keep hand-updating.
