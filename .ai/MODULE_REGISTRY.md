...
47. **[benchmark] CRM: sales coaching / call-scoring rubrics** — structured scorecards (talk-ratio, objection-handling, next-steps-set) applied to the conversation-intelligence call log, manager review workflow, coaching library. Leaders: Gong, Chorus.ai, Salesloft. RICE: Reach 35 · Impact 6 · Confidence 45% · Effort 4 = **47**.
48. **[benchmark] CRM: deal room / mutual action plan** — shared buyer-seller collaborative workspace (milestones, shared documents, stakeholder tracking) attached to an Opportunity, extending the customer portal. Leaders: DealHub, Recapped, Salesforce Digital Sales Room. RICE: Reach 30 · Impact 6 · Confidence 45% · Effort 5 = **32**.
49. **[benchmark] CRM: lead-to-account matching & account hierarchy rollups** — parent/child account hierarchy with automatic rollup of opportunity/revenue metrics to the top-level account, deepening `crm-account-management.service.ts`. Leaders: Salesforce Account Hierarchy, Dynamics 365. RICE: Reach 40 · Impact 5 · Confidence 55% · Effort 4 = **28**.
