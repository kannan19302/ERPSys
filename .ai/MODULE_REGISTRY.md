...
36. **[benchmark] CRM: customer portal document/PDF download** — the shipped customer portal (item 15) returns structured JSON only; leaders let the customer download an actual quote/invoice PDF from the portal. Leaders: Odoo, Zoho, Dynamics. RICE: Reach 40 · Impact 5 · Confidence 55% · Effort 3 = **37**.
37. **[benchmark] CRM: customer portal online payment collection** — let a portal customer pay an open invoice via a payment gateway directly from `/public/customer-portal/dashboard` (no such flow exists yet — portal is read+quote-decision only). Leaders: Zoho, Dynamics, Odoo. RICE: Reach 45 · Impact 7 · Confidence 45% · Effort 5 = **28**.
38. **[benchmark] CRM: pipeline inspection / stage-change risk alerts** — Einstein-style "this deal has been stuck in stage N for M days" / stalled-deal risk surfacing on top of the existing `crm-forecasting.service.ts`; 2026 market discovery (WebSearch) shows Salesforce Einstein Pipeline Inspection and HubSpot Breeze forecast-confidence scoring are now baseline enterprise-CRM expectations, not a differentiator — UniERP's forecasting is currently manually-entered-stage-only. Leaders: Salesforce Einstein, HubSpot Breeze. RICE: Reach 50 · Impact 7 · Confidence 45% · Effort 5 = **32**.
