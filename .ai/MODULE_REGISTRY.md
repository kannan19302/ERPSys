...
5m. **Inventory: quality-inspection workflow deepening** — `QualityInspection` CRUD exists; add inspection-triggered quarantine linkage, pass/fail disposition routing, and inspection template library. Part of the 90→200 plan.
5n. **Inventory: reorder-rule automation deepening** — `ReorderRule` CRUD exists; add auto-generated purchase-requisition creation when triggered, lead-time-aware reorder point calculation, and a reorder dashboard. Part of the 90→200 plan.
