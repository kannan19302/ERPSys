...
5k. **Inventory: wave-pick / pack-list generation** — batch multiple sales-order pick lists into a wave, generate pack-list documents, pick-path sequencing using bin locations. Part of the 90→200 plan.
5l. **Inventory: serial/lot capture-at-receipt-scan** — capture/verify serial and lot numbers at receipt scan time rather than separate manual create (remaining half of item 5c). Part of the 90→200 plan.
