...
17. **[benchmark] Finance: dynamic allocation engine** — allocate expenses across cost centers dynamically based on static ratios or dynamic stats (headcount, square footage). Leaders: Sage Intacct Dynamic Allocations, NetSuite Financial Allocations. Sub-tasks: `AllocationRule` model, pool configuration service, execution journal runs. RICE: Reach 45 · Impact 8 · Confidence 80% · Effort 2.5 = **115.2**.
18. **[benchmark] Finance: consolidation intercompany auto-elimination** — identify intercompany transaction matches and auto-eliminate them during close. Leaders: NetSuite OneWorld, FloQast. Sub-tasks: `EliminationRule` model, elimination run engine, consolidation elimination journals. RICE: Reach 40 · Impact 8 · Confidence 75% · Effort 2 = **120**.
