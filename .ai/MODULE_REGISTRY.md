...
5c. **[benchmark] Inventory: serial & lot number tracking with full traceability** — capture/verify serial and lot numbers at receipt, pick, and pack; genealogy/where-used trace for recalls and compliance. `SerialNumber`/`Batch` models already exist; still open: genealogy/where-used trace reporting UI. Leaders: NetSuite WMS, Manhattan Active WMS, Zoho Inventory. RICE: Reach 55 · Impact 8 · Confidence 55% · Effort 5 = **48**. (Same discovery pass.)
