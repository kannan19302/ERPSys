...
44. **[benchmark] CRM: sales gamification & real-time leaderboards** — rep/team leaderboards, streaks, and badge-style recognition driven by closed-won deals and activity volume (SalesScreen/Ambition-style), deepening `crm-revops.service.ts`. Leaders: SalesScreen, Ambition, Spinify. RICE: Reach 35 · Impact 5 · Confidence 55% · Effort 3 = **58**.
...
46. **[benchmark] CRM: commission plan automation deepening** — tiered/accelerator commission plan rules engine (quota attainment bands, SPIFFs) beyond the flat-rate calc in `crm-revops.service.ts`'s `getCommissions()`. Leaders: Xactly, CaptivateIQ, Spiff. RICE: Reach 30 · Impact 6 · Confidence 50% · Effort 5 = **18**.
