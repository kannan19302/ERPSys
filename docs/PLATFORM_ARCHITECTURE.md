...
**Programme completion: ~97%**, weighted by the § 14 timeline (59 scheduled weeks, Phases 0–5).
...
| 3 — Extract, lowest layer first |      12 wk | **~92%** | 19 repos extracted · **11 packages published and installable** · 2 real cross-boundary compiles ✅ · monorepo deletion remains ⛔ |
